...
class PostingPDL_pg extends MY_Controller {
    ...
    public function get_data() {
        ...
        $result = $this->mpdl->get_pdl_postgres($idpel, $tiket);
    ...
    public function get_detail() {
        ...
        $result = $this->mpdl->get_pdl_detail_postgres($noagenda, $idpel);
        if ($result['status'] === 'success') {
            return $this->response(200, 'success', $result['message'], $result['data']);
        } else {
            return $this->response(400, 'error', $result['message']);
    ...
    public function save() {
        ...
        $result = $this->mpdl->save_pdl_postgres($params);
        if ($result['status'] === 'success') {
