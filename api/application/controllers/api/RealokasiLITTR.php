...
class RealokasiLITTR extends MY_Controller {
    ...
    public function get_data() {
        ...
        $result = $this->mrealokasilittr->get_data_oracle($noagenda);
    ...
    public function save() {
        ...
        $result = $this->mrealokasilittr->save_realokasi_oracle($params);
        if ($result['status'] === 'success') {
