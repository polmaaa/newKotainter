...
class UpdateRoleUser extends MY_Controller {

    protected $protected = true; // Session protection
    ...
    public function save_role() {
        ...
        $params = array(
            ...
            'roles' => isset($json_data['roles']) ? trim($json_data['roles']) : '',
        ...
        $result = $this->mmanajemenuser->set_role_user_oracle($params);
        if ($result['status'] === 'success') {
